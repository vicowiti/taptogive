                                    ...
                                    <div className="sm:flex sm:items-start">
                                        ...
                                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <div className="mt-2 grid grid-cols-2">
                                                <OldInput name='name' type='text' label='Branch Name' placeholder='Enter Name' value={name} setter={setName} />
                                                <OldInput name='Description' type='text' label='Branch Location' placeholder='Enter Location' value={description} setter={setDescription} />
                                                <OldInput name='startDate' type='text' label='Phone Number' placeholder='07xxxxxx' value={startDate} setter={setStartDate} />
                                                <OldInput name='endDate' type='text' label='Contact Person' placeholder='Enter Date' value={endDate} setter={setEndDate} />
                                            </div>
