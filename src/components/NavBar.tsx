...
const NavBar = () => {
  return (
     <header>
       <div className="absolute inset-x-0 top-[-10rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-20rem] bg-[#f8f8f8]">
        <svg
        ...
        <Popover className="relative bg-[#f8f8f8] shadow">
