                                    ...
                                    <div className="sm:flex sm:items-start">
                                        ...
                                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <div className="mt-2 grid grid-cols-2">
                                                <OldInput name='name' type='text' label='Category Name' placeholder='Enter Name' value={name} setter={setName} />
                                                <OldInput name='Description' type='text' label='Description' placeholder='Enter Description' value={description} setter={setDescription} />
                                                <OldInput name='startDate' type='date' label='Start Date' placeholder='Start Date' value={startDate} setter={setStartDate} />
                                                <OldInput name='endDate' type='date' label='End Date' placeholder='Enter Date' value={endDate} setter={setEndDate} />
                                            </div>
