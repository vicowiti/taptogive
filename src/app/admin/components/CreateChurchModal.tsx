...
export default function CreateChurchModal() {
                    ...
                    <div className="mt-3 text-center w-full sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                       <div className="grid grid-cols-2 gap-5 w-full">
                            ...
                            <AdminInput name="person" label="Contact Person" type="text" required={true}/>
                            <AdminInput name="email" label="Church Email" type="email" required={true}/>
                            <AdminInput name="logo" label="Church Logo" type="file" required={true}/>
                       </div>
                      </div>
                    </div>
                  </div>
